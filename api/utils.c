...
// void fa_free_promise(JSContext *ctx, TJSPromise *p) {
//     JS_FreeValue(ctx, p->rfuncs[0]);
//     JS_FreeValue(ctx, p->rfuncs[1]);
//     JS_FreeValue(ctx, p->p);
// }

// void fa_free_promiseRT(JSRuntime *rt, TJSPromise *p) {
